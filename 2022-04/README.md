...
Let *s<sub>i</sub>, s<sub>j</sub>* be the sums of two rows/columns/diagonals in an almost magic square.
The constraint *|s<sub>i</sub> - s<sub>j</sub>| <= 1* can be broken up into two constraints, *s<sub>i</sub> - s<sub>j</sub> <= 1* and *s<sub>j</sub> - s<sub>i</sub> <= 1*.
